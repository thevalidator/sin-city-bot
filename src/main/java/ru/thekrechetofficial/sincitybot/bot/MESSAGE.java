...
public enum MESSAGE {
    ...
    HELP("КРАТКИЙ ИНСТРУКТАЖ" +
            ...
            "\n\n- Для просмотра свежих объявлений выбери \"Поиск\" -> \"Объявления\". Затем нужно" +
            " выбрать пол и кол-во последних опубликованных объявлений. " +
            "\n\n- Для поиска всех объявлений, опубликованных когда либо от определенного контакта, используй \"Розыск\" в разделе меню " + 
            "\"Поиск\". " +
